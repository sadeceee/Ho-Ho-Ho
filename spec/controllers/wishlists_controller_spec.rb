...
RSpec.describe WishlistsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all wishlists as @wishlists" do
      ...
      expect(assigns(:wishlists)).to eq([wishlist])
    end
  end
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved wishlist as @wishlist" do
        post :create, {:wishlist => invalid_attributes}, valid_session
        expect(assigns(:wishlist)).to be_a_new(Wishlist)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested wishlist" do
        wishlist = Wishlist.create! valid_attributes
        put :update, {:id => wishlist.to_param, :wishlist => new_attributes}, valid_session
        wishlist.reload
    ...
    context "with invalid params" do
      it "assigns the wishlist as @wishlist" do
        wishlist = Wishlist.create! valid_attributes
        put :update, {:id => wishlist.to_param, :wishlist => invalid_attributes}, valid_session
        expect(assigns(:wishlist)).to eq(wishlist)
      end
